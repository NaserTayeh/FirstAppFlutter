...
class PhotoCellScreen extends StatefulWidget {
  static const screenRoute = '/photocell_items';

  @override
  State<PhotoCellScreen> createState() => _PhotoCellScreenState();
}

class _PhotoCellScreenState extends State<PhotoCellScreen> {
              ...
              Container(
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      sign_items
                          .where((element) => element.groupNum == 3)
                          .toList()[0]
                          .groupTitle,
                      style: TextStyle(
