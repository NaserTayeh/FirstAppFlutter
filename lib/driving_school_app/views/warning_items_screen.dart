...
class WariningItemsScreen extends StatefulWidget {
  static const screenRoute = '/warning_items';

  @override
  State<WariningItemsScreen> createState() => _WariningItemsScreenState();
}

class _WariningItemsScreenState extends State<WariningItemsScreen> {
              ...
              Container(
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      sign_items
                          .where((element) => element.groupNum == 0)
                          .toList()[0]
                          .groupTitle,
                      style: TextStyle(
